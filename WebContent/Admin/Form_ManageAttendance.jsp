      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="panel panel-default">
              ...
              <input type="hidden" name="flag" value="insertAttendance">
                <div class="form-group">
                  <label class="col-sm-3 control-label">In-Time <span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                    <input type="text" name="intime" class="form-control" placeholder="Type In-time..." required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="outtime" class="form-control" placeholder="Type Out-time..." required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="date" class="form-control" placeholder="Type Date..." required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <textarea rows="5" name="details" class="form-control" placeholder="Write Details..." required></textarea>
                  </div>
                </div>
              </div><!-- panel-body -->
