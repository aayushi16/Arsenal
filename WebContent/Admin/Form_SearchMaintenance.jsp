        ...
        <ol class="breadcrumb">
          ...
          <div class="table-responsive">
            <table class="table" id="table1">
              ...
              <tbody>
              	<c:forEach items="${sessionScope.maintenance_list}" var="i">
              		<c:if test="${sessionScope.usertype eq 'Admin' }">
						...
						<td>${i.to.user_name }</td>
							...
							<td><div class="btn-group mr5">
												...
												<ul class="dropdown-menu" role="menu">
													<li><a
														href="${pageContext.request.contextPath }/MaintenanceController?flag=editMaintenance&maintenanceId=${i.m_id }">Edit</a></li>
													<li><a
														href="${pageContext.request.contextPath }/MaintenanceController?flag=delete&maintenanceID=${i.m_id }">Delete</a></li>	
												</ul>
											</div>
					...
					<c:if test="${sessionScope.usertype eq 'Officer' }">
                	<c:if test="${i.userVO.user_post ne 'Admin' }">
                    ...
                    <tr>
                       ...
                       <c:if test="${sessionScope.usertype eq 'Soldier' }">
					<c:if test="${i.to.user_id eq sessionScope.userID}">
