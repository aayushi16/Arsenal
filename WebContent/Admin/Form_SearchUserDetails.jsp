        ...
        <ol class="breadcrumb">
          ...
          <div class="table-responsive">
            <table class="table" id="table1">
              ...
              <tbody>
              	<c:forEach items="${sessionScope.user1_list }" var="i">
              	<c:if test="${sessionScope.usertype eq 'Admin' }">
                	<tr>
                  		<td>${i.user1_id}</td>
                  		<td>${i.user1_no}</td>
						...
						<td class="center">
								...
								<div class="btn-group mr5">
									...
									<ul class="dropdown-menu" role="menu">
										<li><a
											href="<%=request.getContextPath() %>/UserDetailsController?flag=edit&userdetailsID=${i.user1_id }">Edit</a></li>
										<li><a
											href="<%=request.getContextPath() %>/UserDetailsController?flag=delete&userdetailsID=${i.user1_id }">Delete</a></li>
									</ul>
								</div>	
						</td>
					</tr>
