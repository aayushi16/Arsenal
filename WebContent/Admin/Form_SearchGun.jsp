						...
						<td class="center">
											<div class="btn-group mr5">
												...
												<ul class="dropdown-menu" role="menu">
													<li><a
														href="${pageContext.request.contextPath }/GunController?flag=edit&gunID=${i.gun_id }">Edit</a></li>
													<li><a
														href="${pageContext.request.contextPath }/GunController?flag=delete&gunID=${i.gun_id }">Delete</a></li>
												</ul>
											</div>
