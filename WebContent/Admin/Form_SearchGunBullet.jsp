        ...
        <ol class="breadcrumb">
          ...
          <div class="table-responsive">
            <table class="table" id="table1">
              ...
              <tbody>
              	<c:forEach items="${sessionScope.gunbullet_list}" var="i">
                	<tr>
                  		<td>${i.bullet_id}</td>
						<td>${i.bullet_no}</td>
						...
						<td class="center">
											<div class="btn-group mr5">
												...
												<ul class="dropdown-menu" role="menu">
													<li><a
														href="${pageContext.request.contextPath }/GunBulletController?flag=edit&gunbulletID=${i.bullet_id }">Edit</a></li>
													<li><a
														href="${pageContext.request.contextPath }/GunBulletController?flag=delete&gunbulletID=${i.bullet_id }">Delete</a></li>
												</ul>
											</div>
