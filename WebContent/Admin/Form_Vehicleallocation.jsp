          ...
          <div class="panel panel-default">
             ...
             <!--    <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                   <select id="vehicle" name="vehicle" data-placeholder="Choose One" title="Please select vehicle" class="select2" required>
                      <option value="">Choose One</option>
                       <c:forEach items="${sessionScope.vehicle_list}" var="i">
                ...
                <input type="hidden" name="flag" value="insertVehiclestock">
                <div class="form-group">
                  <label class="col-sm-3 control-label">Vehicle No. <span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                    <input type="text" name="vehicleno" class="form-control" placeholder="Type Vehicle No...." required />
                  </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <!-- <div class="col-sm-9">
                    <input type="text" name="assignTime" class="form-control" placeholder="Type Assigning details..." required />
                  </div>-->
               ...
               <label class="col-sm-3 control-label">Gasoline Required <span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                    <input type="text" name="gas" class="form-control" placeholder="Type litres of Gasoline Required..." required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="km" class="form-control" placeholder="Type Travelled Kilometres..." required />
                  </div>
                </div>
