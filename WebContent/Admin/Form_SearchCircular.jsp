						...
						<td class="center">
											<div class="btn-group mr5">
												...
												<ul class="dropdown-menu" role="menu">
													<li><a
														href="${pageContext.request.contextPath }/CircularController?flag=edit&circularID=${i.circular_id }">Edit</a></li>
													<li><a
														href="${pageContext.request.contextPath }/CircularController?flag=delete&circularID=${i.circular_id }">Delete</a></li>	
												</ul>
											</div>
