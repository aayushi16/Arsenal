    ...
    <div class="pageheader">
      ...
      <div class="breadcrumb-wrapper">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="Form_EditUser.jsp">Forms</a></li>
    ...
    <div class="contentpanel">
      ...
      <div class="row">
        ...
        <c:forEach items="${sessionScope.user_list }" var="i">
          <form id="basicForm" action="${pageContext.request.contextPath }/UserController" class="form-horizontal" method="post">
          <div class="panel panel-default">
			...
			<input type="hidden" name="flag" value="update">	              
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="userName" class="form-control" placeholder="Type Username..." required="" value="${i.user_name}" />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="password" name="Password" class="form-control" placeholder="Type Password..." required="" value="${i.password}" />
                  </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="email" name="email" id="email" class="form-control" placeholder="Type Email_ID..." required="" value="${i.email}" />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <textarea rows="5" name="status" class="form-control" placeholder="Write Status..." required="">${i.status}</textarea>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="Post" class="form-control" placeholder="Type User Post..." required="" value="${i.user_post}" />
                  </div>
                </div>
