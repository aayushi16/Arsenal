						...
						<td class="center">
											<div class="btn-group mr5">
												...
												<ul class="dropdown-menu" role="menu">
													<li><a
														href="${pageContext.request.contextPath }/VehicleController?flag=edit&vehicleID=${i.vehicle_id }">Edit</a></li>
													<li><a
														href="${pageContext.request.contextPath }/VehicleController?flag=delete&vehicleID=${i.vehicle_id }">Delete</a></li>
												</ul>
											</div>
