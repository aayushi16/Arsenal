          ...
          <div class="panel panel-default">
    		...
    		<c:if test="${sessionScope.usertype eq 'Admin' }">
               <div class="col-md-12">
              	...
              	<iframe src="${pageContext.request.contextPath }/Admin/line.jsp" class="col-md-12" style="overflow:none; border: none;height:350px;width:1000px;"></iframe>
              
              </div>
            
            
              <div class="col-md-12">
              <iframe src="${pageContext.request.contextPath }/Admin/pie.jsp" class="col-md-12" style="overflow: none; border: none; height:350px;width:1000px;"></iframe>
              </div>
             </c:if>
            <!--   <div class="col-sm-8">
