...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-table"></i> Pending List <span></span></h2>
            ...
            <table class="table" id="table1">
              <thead>
                 <tr>
                    ...
                    <th>Return Number of Bullets</th>
                    <th>Officer Name</th>
                    <th>Soldier Name</th>
                    <th>Gun Name</th>
                    <th>Action</th>
              ...
              <tbody>
              	<c:forEach items="${sessionScope.gunallocation_list}" var="i">
                	<tr>
						...
						<td>${i.quantity}</td>
						<td>${i.assign_time}</td>
						<td>${i.retrieve_time}</td>
						<th>${i.assign_status}</th>
						<th>${i.return_status}</th>
						<th>${i.no_bullets}</th>
						<th>${i.return_bullets}</th>
						<td>${i.userVO.user_name }</td>
						<td>${i.to.user_name }</td>
						<td>${i.gunVO.gun_name }</td>
						<td class="center">
											<div class="btn-group mr5">
												...
												<ul class="dropdown-menu" role="menu">
													<li><a
														href="${pageContext.request.contextPath }/GunallocationController?flag=edit&stock1ID=${i.stock1_id }">Edit</a></li>
													<li><a
														href="${pageContext.request.contextPath }/GunallocationController?flag=delete&stock1ID=${i.stock1_id }">Delete</a></li>
												</ul>
											</div>
