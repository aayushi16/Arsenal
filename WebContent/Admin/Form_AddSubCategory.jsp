...
function check()
{
		...
		var a=document.getElementById("subcatName").value.trim();
	/* if(a=="")
		{
				...
				if(flag[0].firstChild.nodeValue=="true")
					...
					//alert("sdfsd")
					...
					else
						{
							...
							alert("Already Assigned Subcategory Name ")
							document.basicForm.subcatName.focus();
							flaginsert= false;
						}
		...
		xmlhttp.open("get","${pageContext.request.contextPath}/SubCategoryController?flag=validate&name="+a,true);
		xmlhttp.send();
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      ...
      <div class="breadcrumb-wrapper">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="Form_AddSubCategory.jsp">Forms</a></li>
    ...
    <div class="contentpanel">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <form id="basicForm" action="<%=request.getContextPath() %>/SubCategoryController" method="post" class="form-horizontal">
          <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="subcatName" id="subcatName" class="form-control" placeholder="Type SubCategory Name..." required  onblur="check()" />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <textarea rows="5" name="subcatDes" class="form-control" placeholder="Write Description..." required></textarea>
                  </div>
                </div>
              </div><!-- panel-body -->
