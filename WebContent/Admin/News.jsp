      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="panel panel-default">
              ...
              <input type="hidden" name="flag" value="insertNews">
                <div class="form-group">
                  <label class="col-sm-3 control-label">Title<span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                    <input type="text" name="newsTitle" class="form-control" placeholder="Type News Title..." required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <textarea rows="5" name="newsDes" class="form-control" placeholder="Write Description..." required></textarea>
                  </div>
                </div>
              </div><!-- panel-body -->
