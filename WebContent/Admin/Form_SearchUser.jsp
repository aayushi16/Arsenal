            ...
            <table class="table" id="table1">
              ...
              <tbody>
              	<c:forEach items="${sessionScope.user_list}" var="i">
						...
						<td class="center">
											<div class="btn-group mr5">
												...
												<ul class="dropdown-menu" role="menu">
													<li><a
														href="${pageContext.request.contextPath }/UserController?flag=edit&userID=${i.user_id }">Edit</a></li>
													<li><a
														href="${pageContext.request.contextPath }/UserController?flag=delete&userID=${i.user_id }">Delete</a></li>
												</ul>
											</div>
					...
					<c:if test="${sessionScope.usertype eq 'Officer' }">
                	<c:if test="${i.user_post ne 'Admin' }">
                	<tr>
                  		<td>${i.user_id}</td>
						<td>${i.user_name}</td>
						<td>${i.password}</td>
					...
					<c:if test="${sessionScope.usertype eq 'Soldier' }">
					<c:if test="${i.user_id eq sessionScope.userID}">
                	<tr>
                  		<td>${i.user_id}</td>
						<td>${i.user_name}</td>
						<td>${i.password}</td>
