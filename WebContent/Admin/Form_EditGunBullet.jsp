          ...
          <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="bulletNO" class="form-control" placeholder="Type Username..." required="" value="${i.bullet_no}" />
                  </div>
                </div>
             ...
             <input type="hidden" name="gunbulletID" value="${i.bullet_id }">
          </div><!-- panel -->
          </form>
          </c:forEach>
