        ...
        <div class="col-md-6">
          ...
          <div class="panel panel-default">
              ...
              <div class="panel-body">
              	...
              	<input type="hidden" name="flag" value="insertCircular">
                <div class="form-group">
                  <label class="col-sm-3 control-label">Title <span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                    <input type="text" name="cirTitle" class="form-control" placeholder="Type Circular Title..." required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <textarea rows="5" name="cirDes" class="form-control" placeholder="Write Description..." required></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-3 control-label">Description <span class="asterisk">*</span></label>
