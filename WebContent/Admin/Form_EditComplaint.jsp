...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="contentpanel">
      ...
      <div class="row">
	 <%@ taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
        <c:forEach items="${sessionScope.complaint_list}" var="i">            
        <div class="col-md-6">
          ...
          <div class="panel panel-default">
           ...
           <input type="hidden" name="flag" value="update"> 
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="cn" class="form-control" placeholder="Type Complaint Name..." required="" value="${i.complaint_name}" />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="ct" class="form-control" placeholder="Type Complaint Type..." required="" value="${i.complaint_type}" />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="cd" class="form-control" placeholder="Type Date..." required="" value="${i.complaint_date}" />
                  </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <textarea rows="5" name="msg" class="form-control" placeholder="Write Complaint..." required>${i.message}</textarea>
                  </div>
                </div>
                    <!-- <input type="hidden" name="flag" value="mail"> -->       
                 <div class="form-group">
                  <label class="col-sm-3 control-label">Reply <span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                    <textarea rows="5" name="reply" class="form-control" placeholder="Reply Complaint..." required>${i.reply}</textarea>
                  </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="email" class="form-control" placeholder="Type Email..." required="" value="${i.email}" />
                  </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="status" class="form-control" placeholder="Type status..." required="" value="${i.status}" />
                  </div>
                </div>
                
                <input type="hidden" name="complaintID" value="${i.c_id }"> 
              </div><!-- panel-body -->
