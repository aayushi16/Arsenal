	<div class="leftpanel">
		...
		<div class="leftpanelinner">
			...
			<ul class="nav nav-pills nav-stacked nav-bracket">
				<li class="active"><a
					href="<%=request.getContextPath() %>/GunallocationController?flag=loadIndex"><i
						class="fa fa-home"></i> <span>Dashboard</span></a></li>
				<li class="nav-parent"><a href="<%=request.getContextPath()%>/Admin/index-2.jsp"><i class="fa fa-edit"></i>
						<span>Manage Category</span></a>
					<ul class="children">
						<li><a
							href="<%=request.getContextPath() %>/Admin/Form_AddCategory.jsp"><i
								class="fa fa-caret-right"></i> Add Category</a></li>
						<li><a
				...
				<li class="nav-parent"><a href=""><i class="fa fa-edit"></i>
					...
					<ul class="children">
						<li><a
							href="<%=request.getContextPath() %>/SubCategoryController?flag=loadCategory"><i
								class="fa fa-caret-right"></i> Add SubCategory</a></li>
						<li><a
				...
				<li class="nav-parent"><a href=""><i class="fa fa-edit"></i>
					...
					<ul class="children">
						<li><a
							href="<%=request.getContextPath() %>/Admin/Form_User.jsp"><i
								class="fa fa-caret-right"></i> Add User</a></li>
						<li><a
			...
			<!--  	<li class="nav-parent"><a href=""><i class="fa fa-edit"></i>
				...
				<li class="nav-parent"><a href=""><i class="fa fa-edit"></i>
					...
					<ul class="children">
						...
						<!--<li class=""><a href="${pageContext.request.contextPath}/Admin/Form_ReviewUser.jsp"><i
						class="fa fa-edit"></i> <span>Review User</span></a></li>-->
			</ul>
