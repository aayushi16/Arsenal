...
function check()
{
		...
		var a=document.getElementById("gunNo").value.trim();
	/* if(a=="")
		{
			...
			//	alert("dddddddddddddd"+x);
				if(flag[0].firstChild.nodeValue=="true")
					...
					//alert("sdfsd")
						...
						{
							document.getElementById("gunNo").value="";
							alert("Already Assigned Gun Number ")
							document.basicForm.gunNo.focus();
							flaginsert= false;
						}
		...
		xmlhttp.open("get","${pageContext.request.contextPath}/GunController?flag=validate&name="+a,true);
		xmlhttp.send();
    ...
    <div class="pageheader">
      ...
      <div class="breadcrumb-wrapper">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="Form_Addgun.jsp">Forms</a></li>
        ...
        <div class="col-md-6">
          ...
          <div class="panel panel-default">
             ...
             <div class="panel-body">
              ...
              <input type="hidden" name="flag" value="insertGun">
                <div class="form-group">
                  <label class="col-sm-3 control-label">Gun No. <span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                    <input type="text" name="gunNo" id="gunNo" class="form-control" placeholder="Type Gun No. ..." required="" onblur="check()" />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="gunName" class="form-control" placeholder="Type Gun Name..." required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <textarea rows="5" name="gunDes" class="form-control" placeholder="Write Description..." required></textarea>
                  </div>
                </div>
              </div><!-- panel-body -->
