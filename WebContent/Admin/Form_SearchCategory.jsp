						...
						<td class="center">
											<div class="btn-group mr5">
												...
												<ul class="dropdown-menu" role="menu">
													<li><a
														href="${pageContext.request.contextPath }/CategoryController?flag=edit&categoryID=${i.cat_id }">Edit</a></li>
													<li><a
														href="${pageContext.request.contextPath }/CategoryController?flag=delete&categoryID=${i.cat_id }">Delete</a></li>	
												</ul>
											</div>
