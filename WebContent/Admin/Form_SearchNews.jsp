        ...
        <ol class="breadcrumb">
          ...
          <div class="table-responsive">
            <table class="table" id="table1">
              ...
              <tbody>
              	<c:forEach items="${sessionScope.news_list}" var="i">
                	<tr>
                  		<td>${i.news_id}</td>
						<td>${i.news_title}</td>
						...
						<td class="center">
											<div class="btn-group mr5">
												...
												<ul class="dropdown-menu" role="menu">
													<li><a
														href="${pageContext.request.contextPath }/NewsController?flag=edit&newsID=${i.news_id }">Edit</a></li>
													<li><a
														href="${pageContext.request.contextPath }/NewsController?flag=delete&newsID=${i.news_id }">Delete</a></li>	
												</ul>
											</div>
