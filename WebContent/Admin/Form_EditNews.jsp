    ...
    <div class="pageheader">
      ...
      <div class="breadcrumb-wrapper">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="Form_ReviewUser.jsp">Forms</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
         <c:forEach items="${sessionScope.news_list }" var="i">
          <form id="basicForm" action="${pageContext.request.contextPath }/NewsController" method="post" class="form-horizontal">
          <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <p>Provide Base Camp News</p>
              </div>
              <div class="panel-body">
              
              <input type="hidden" name="flag" value="updateNews">
                <div class="form-group">
                  <label class="col-sm-3 control-label">Title<span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                    <input type="text" name="newsTitle" class="form-control" placeholder="Type News Title..." required="" value="${i.news_title}" />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <textarea rows="5" name="newsDes" class="form-control" placeholder="Write Description..." required="" >${i.news_description}</textarea>
                  </div>
                </div>
                <input type="hidden" name="newsID" value="${i.news_id }">
              </div><!-- panel-body -->
