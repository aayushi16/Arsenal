                	...
                	<tr>
						...
						<td><div class="btn-group mr5">
												...
												<ul class="dropdown-menu" role="menu">
													<li><a
														href="${pageContext.request.contextPath }/SubCategoryController?flag=editSubCategory&subcategoryId=${i.subcat_id }">Edit</a></li>
													<li><a
														href="${pageContext.request.contextPath }/SubCategoryController?flag=delete&subcategoryID=${i.subcat_id }">Delete</a></li>	
												</ul>
											</div>
