...
<!-- Mirrored from themepixels.com/demo/webpage/bracket/tables.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Oct 2014 06:25:34 GMT -->
<head>
  <meta charset="utf-8">
...
<c:if test="${sessionScope.usertype eq 'Officer' }">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-table"></i> Tables <span></span></h2>
            ...
            <table class="table" id="table1">
              ...
              <tbody>
              	<c:forEach items="${sessionScope.complaint_list}" var="i">
              		<c:if test="${sessionScope.usertype eq 'Soldier' }">
              			<c:if test="${i.userVO.user_id eq sessionScope.userID}">
                	<tr>
                  		<td>${i.c_id}</td>
                  		<td>${i.complaint_name}</td>
						<td>${i.complaint_type}</td>
						<td>${i.complaint_date}</td>
						<td>${i.message}</td>
						<td>${i.status }</td>
						<td>${i.userVO.user_name}</td>
							<%-- <td><div class="btn-group mr5">
												<button type="button"
													class="btn btn-success dropdown-toggle"
													data-toggle="dropdown">
													Acftion <span class="caret"></span>
												</button>
												<ul class="dropdown-menu" role="menu">
													<li><a
														href="${pageContext.request.contextPath }/ComplaintController?flag=editComplaint&complaintId=${i.c_id }">Edit</a></li>
													<li><a
														href="${pageContext.request.contextPath }/ComplaintController?flag=delete&complaintID=${i.c_id }">Delete</a></li>	
												</ul>
											</div>
							...
							<c:if test="${sessionScope.usertype eq 'Officer' }">
                <%-- 	<c:if test="${i.userVO.user_post ne 'Soldier' }"> --%>
					<tr>
                  		<td>${i.c_id}</td>
                  		<td>${i.complaint_name}</td>
						<td>${i.complaint_type}</td>
					...
					<tr>
						...
						<td>${i.userVO.user_name}</td>
							<td><div class="btn-group mr5">
												...
												<ul class="dropdown-menu" role="menu">
													<li><a
														href="${pageContext.request.contextPath }/ComplaintController?flag=editComplaint&complaintId=${i.c_id }">Reply</a></li>
											</div>
...
<!-- Mirrored from themepixels.com/demo/webpage/bracket/tables.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Oct 2014 06:25:35 GMT -->
</html>
