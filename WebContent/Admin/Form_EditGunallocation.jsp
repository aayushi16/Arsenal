    ...
    <div class="pageheader">
      ...
      <div class="breadcrumb-wrapper">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="Form_Gunallocation.jsp">Forms</a></li>
          <li class="active">Gun Allocation</li>
        </ol>
      </div>
    </div>
    ...
    <div class="contentpanel">
      ...
      <div class="row">
        ...
        <c:forEach items="${sessionScope.gunallocation_list}" var="i">
          <form id="basicForm" action="<%=request.getContextPath() %>/GunallocationController" method="post" class="form-horizontal">
          <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <h4 class="panel-title">Gun Allocation</h4>
                <p>Please provide Gun Allocation Details</p>
              </div>
           ...
           <!--    <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                     <select id="gun" name="gun" data-placeholder="Choose One" title="Please select gun" class="select2" required>
                      <option value="">Choose One</option>
                       <c:forEach items="${sessionScope.gun_list}" var="k">
                       <c:if test="${k.gun_id eq i.gunVO.gun_id }">
                      	<option value="${k.gun_id }" selected="selected">${k.gun_name }</option>
                       </c:if>
                       <c:if test="${k.gun_id ne i.gunVO.gun_id }">
                      	<option value="${k.gun_id }">${k.gun_name }</option>
                       </c:if>
                      </c:forEach>
                    </select>
                    <label class="error" for="flowers"></label>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="quantity" class="form-control" placeholder="Type Quantity..." required="" value="${i.quantity}" />
                  </div>
                </div>
                 ...
                 <!--  <div class="col-sm-9">
                    <input type="text" name="assignTime" class="form-control" placeholder="Type Assigning details..." required="" value="${i.assign_time}"/>
                  </div>-->
                ...
                <div class="bootstrap-timepicker"><input name="tp" id="timepicker" type="text" class="form-control" value="${i.assign_time}"></div>
                 ...
                 <div class="form-group">
                  ...
                  <!--  <div class="col-sm-9">
                    <input type="text" name="retrieveTime" class="form-control" placeholder="Type Retrieving details..." required="" value="${i.retrieve_time}" />
                  </div>-->
                    <div class="input-group mb15">
                <span class="input-group-addon"><i class="glyphicon glyphicon-time"></i></span>
                <div class="bootstrap-timepicker"><input name="rp" id="timepicker_1" type="text" class="form-control" value="${i.retrieve_time}"></div>
                 ...
                 <div class="form-group">
                  <label class="col-sm-3 control-label">Return Status</label>
                  <div class="col-sm-9">
                ...
                <div class="form-group">
               <label class="col-sm-3 control-label">No. of Bullets <span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                    <input type="text" name="nb" class="form-control" placeholder="Type Bullet Count..." required="" value="${i.no_bullets}" />
                  </div>
                </div>
                
                <div class="form-group">
                  <label class="col-sm-3 control-label">Returned No. of Bullets <span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                    <input type="text" name="rb" class="form-control" placeholder="Type Returning Bullet Count..." required="" value="${i.return_bullets}" />
                  </div>
                </div>
                <input type="hidden" name="stock1ID" value="${i.stock1_id }">
              </div><!-- panel-body -->
