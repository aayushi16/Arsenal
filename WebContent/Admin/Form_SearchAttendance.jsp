						...
						<td>${i.userVO.user_name }</td>
							<td><div class="btn-group mr5">
												...
												<ul class="dropdown-menu" role="menu">
													<li><a
														href="${pageContext.request.contextPath }/AttendanceController?flag=editAttendance&attendanceId=${i.att_id }">Edit</a></li>
													<li><a
														href="${pageContext.request.contextPath }/AttendanceController?flag=delete&attendanceID=${i.att_id }">Delete</a></li>	
												</ul>
											</div>
