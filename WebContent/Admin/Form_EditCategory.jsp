  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      ...
      <div class="breadcrumb-wrapper">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="Form_EditCategory.jsp">Forms</a></li>
    ...
    <div class="contentpanel">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
        <c:forEach items="${sessionScope.category_list }" var="i">
          ...
          <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="categoryName" class="form-control" placeholder="Type your category name..." required="" value="${i.cat_name}">
                  </div>
                </div>
                
                <div class="form-group">
                  <label class="col-sm-2 control-label">Category Description <span class="asterisk">*</span></label>
                  <div class="col-sm-6">
                    <textarea rows="5" name="categoryDes" class="form-control" placeholder="Type your comment..." required="" >${i.cat_description}</textarea>
                  </div>
                </div>	              
