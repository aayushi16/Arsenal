              ...
              <tbody>
              	<c:forEach items="${sessionScope.vehicleallocation_list}" var="i">
                	<tr>
						...
						<td>${i.vehicleVO.vehicle_name }</td>
						<td class="center">
											<div class="btn-group mr5">
												...
												<ul class="dropdown-menu" role="menu">
													<li><a
														href="${pageContext.request.contextPath }/VehicleallocationController?flag=edit&stock2ID=${i.stock2_id }">Edit</a></li>
													<li><a
														href="${pageContext.request.contextPath }/VehicleallocationController?flag=delete&stock2ID=${i.stock2_id }">Delete</a></li>
												</ul>
											</div>
