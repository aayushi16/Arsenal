            ...
            <!--    <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                 ...
                 <input type="hidden" name="flag" value="insertGunstock">
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <!-- <div class="col-sm-9">
                    <input type="date" name="assignTime" class="form-control" placeholder="Type Assigning details..." required />
                  </div> -->
                   <div class="input-group mb15">
                <span class="input-group-addon"><i class="glyphicon glyphicon-time"></i></span>
                <div class="bootstrap-timepicker"><input name="tp" id="timepicker" type="text" class="form-control"></div>
              </div>
                 ...
                 <div class="form-group">
                  ...
                  <!-- <div class="col-sm-9">
                    <input type="text" name="retrieveTime" class="form-control" placeholder="Type Retrieving details..." required />
                  </div>-->
                    <div class="input-group mb15">
                <span class="input-group-addon"><i class="glyphicon glyphicon-time"></i></span>
                <div class="bootstrap-timepicker"><input name="rp" id="timepicker_1" type="text" class="form-control"></div>
              </div>
                </div>
               ...
               <label class="col-sm-3 control-label">No. of Bullets <span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                    <input type="text" name="nb" class="form-control" placeholder="Type Bullet Count..." required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="rb" class="form-control" placeholder="Type Returning Bullet Count..." required />
                  </div>
                </div>
